...
function updateUIForAuthStatus() {
    ...
    // NEW: Select all inputs and textareas in the form
    const formInputs = document.querySelectorAll('#book-form input, #book-form textarea');
    ...
    if (isAuthenticated) {
        ...
        // NEW: Disable all inputs so users know they can't type
